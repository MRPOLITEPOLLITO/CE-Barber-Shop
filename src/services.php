    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
        <div class="col-md-9 ftco-animate pb-5 text-center">
          ...
          <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Inicio <i
                  class="ion-ios-arrow-round-forward"></i></a></span> <span>Servicios <i
    ...
    <div class="container">
      <div class="row justify-content-center pb-3">
        <div class="col-md-10 heading-section text-center ftco-animate">
          ...
          <p>Servicios ofertados por la barberia</p>
        </div>
      </div>
      <div class="row">
        <?php
            ...
            <div class="col-md-3 ftco-animate">
              <div class="pricing-entry pb-5 text-center">
                <div>
                  ...
                  <p><span class="price">$<?php echo $row['service_cost'] ?> MXN</span> <span class="per">/ cita</span></p>
                </div>
                <p class="button text-center"><button value="<?php echo $row['service_id'] ?>" class="btn btn-primary px-4 py-3">Reservar</button></p>
              </div>
            </div>
            <?php
          }
