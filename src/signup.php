		...
		<div class="container ftco-relative">
			<div class="row justify-content-center pb-3">
				<div class="col-md-10 heading-section text-center ftco-animate">
					<div class="icon">
						<h2 class="flaticon-beard"></h2>
					</div>
					<h2 class="mb-4">Registrarse</h2>
					<p>Para usar todas las funcionalidades es necesario estar registrado</p>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-10 ftco-animate">
					<form action="querys/checkSignin.php" method="post" id="form" class="appointment-form">
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<input type="text" name="name" required class="form-control"
										pattern="[A-Za-z0-9_-]{1,50}" placeholder="Nombre completo">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<input type="number" name="phone" required class="form-control"
										pattern="[A-Za-z0-9_-]{1,50}" placeholder="Teléfono">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<input type="password" name="password1" required class="form-control"
										pattern="[A-Za-z0-9_-]{1,50}" id="password1" placeholder="Contraseña">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<input type="password" name="password2" required class="form-control"
										pattern="[A-Za-z0-9_-]{1,50}" id="password2" placeholder="Repite la contraseña">
								</div>
							</div>
						</div>
						<div class="form-group">
